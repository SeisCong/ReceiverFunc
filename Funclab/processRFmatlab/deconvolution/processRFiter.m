...
%
% [time, rfseis, rfhdr, ierr] = processRFiter( nseis, dseis, hdr, opt , isVb )
%
% IN:
...
% ierr = 0 for success, 1 for empty rms vector
%-- processRFiter.m --- 
%  
...
%   Sat Aug 9 2014, added ierr flag for error tracking
%   
%-------------------------------------------------------
% TODO 
